...
public class MySecondTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            passwordField.sendKeys("Manisha"); //Wrong Password
            loginButton.click();
            ...
            try {
                ...
                if (errorMessage.isDisplayed()) {
                    System.out.println("Test Invalid Login - Wrong Password: Error message displayed.");
                }
            } catch (Exception e) {
                System.out.println("Test Invalid Login - Wrong Password: Error message not found.");
            }
